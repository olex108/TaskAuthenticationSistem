...
from identity.views import (AdminAddRolePermissionAPIView, AdminAssignUserRoleAPIView, AdminPermissionListAPIView,
                            AdminRemoveRolePermissionAPIView, AdminRevokeUserRoleAPIView, AdminRoleListAPIView,
                            AdminUserDetailsAPIView, LoginView, LogoutAPIView, TokenRefreshView, UserProfileAPIView,
                            UserRegisterAPIView, UserSoftDeleteAPIView)
...
urlpatterns = [
    ...
    path(
        ...
        AdminRemoveRolePermissionAPIView.as_view(),
